...
for(var in dynamic_vars){
  ...
  var_rast <- rast(paste0("E:/Satellite_Data/monthly/", var, "/", var, ".nc"))
...
writeRaster(rf_pred, 
            filename = paste0("output/at-sea model/predictions/", species, "_", stage, "_rf_prediction.tif"),
            overwrite = TRUE)
...
writeRaster(brt_pred, 
            filename = paste0("output/at-sea model/predictions/", species, "_", stage, "_brt_prediction.tif"),
            overwrite = TRUE)
...
writeRaster(maxent_pred, 
            filename = paste0("output/at-sea model/predictions/", species, "_", stage, "_maxent_prediction.tif"),
            overwrite = TRUE)
...
writeRaster(gam_pred, 
            filename = paste0("output/at-sea model/predictions/", species, "_", stage, "_gam_prediction.tif"),
            overwrite = TRUE)
...
writeRaster(bart_pred, 
            filename = paste0("output/at-sea model/predictions/", species, "_", stage, "_bart_prediction.tif"),
            overwrite = TRUE)
...
rf <- rast(paste0("output/at-sea model/predictions/", species, "_", stage, "_rf_prediction.tif"))
brt <- rast(paste0("output/at-sea model/predictions/", species, "_", stage, "_brt_prediction.tif"))
maxent <- rast(paste0("output/at-sea model/predictions/", species, "_", stage, "_maxent_prediction.tif"))
gam <- rast(paste0("output/at-sea model/predictions/", species, "_", stage, "_gam_prediction.tif"))
bart <- rast(paste0("output/at-sea model/predictions/", species, "_", stage, "_bart_prediction.tif"))
...
writeRaster(simple, 
            filename = paste0("output/at-sea model/predictions/", species, "_", stage, "_simple_ensemble.tif"),
            overwrite = TRUE)
writeRaster(weighted,
            filename = paste0("output/at-sea model/predictions/", species, "_", stage, "_weighted_ensemble.tif"),
            overwrite = TRUE)
