...
all_vars <- read.csv(paste0("output/at-sea model/varselection/", species, "_", stage, "_key_vars.csv")) %>%
  pull(key_vars)
...
for(var in static_vars){
  ...
  # read in raster
  var_rast <- rast(paste0("E:/Satellite_Data/static/", var, "/", var, ".nc"))
...
for(var in dynamic_vars){
  ...
  var_rast <- rast(paste0("E:/cmip6_data/CMIP6/deltas/", cmip_var, "/satellite_data/transformed/", gcm, "_", scenario, "_glorysres.tif"))
...
rf <- readRDS(paste0("output/at-sea model/random forests/", species, "_", stage, "_rf_model.RDS"))
...
writeRaster(rf_pred, 
            filename = paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_rf_prediction.tif"),
            overwrite = TRUE)
...
brt <- readRDS(paste0("output/at-sea model/boosted regression trees/", species, "_", stage, "_brt_model.RDS"))
...
writeRaster(brt_pred, 
            filename = paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_brt_prediction.tif"),
            overwrite = TRUE)
...
maxent <- readRDS(paste0("output/at-sea model/maxent/", species, "_", stage, "_maxent_model.RDS"))
...
writeRaster(maxent_pred, 
            filename = paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_maxent_prediction.tif"),
            overwrite = TRUE)
...
# load in GAM model
gam <- readRDS(paste0("output/at-sea model/generalised additive models/", species, "_", stage, "_gam_model.RDS"))
...
writeRaster(gam_pred, 
            filename = paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_gam_prediction.tif"),
            overwrite = TRUE)
...
# load in BART model
bart <- readRDS(paste0("output/at-sea model/bayesian additive regression trees/", species, "_", stage, "_bart_model.RDS"))
...
writeRaster(bart_pred, 
            filename = paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_bart_prediction.tif"),
            overwrite = TRUE)
...
rf <- rast(paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_rf_prediction.tif"))
brt <- rast(paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_brt_prediction.tif"))
maxent <- rast(paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_maxent_prediction.tif"))
gam <- rast(paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_gam_prediction.tif"))
bart <- rast(paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_bart_prediction.tif"))
...
rf_cbi <- readRDS(paste0("output/at-sea model/random forests/", species, "_", stage, "_cbi_scores.rds")) %>%
  pull(.estimate) %>%
  mean()
brt_cbi <- readRDS(paste0("output/at-sea model/boosted regression trees/", species, "_", stage, "_cbi_scores.rds")) %>%
  pull(.estimate) %>%
  mean()
maxent_cbi <- readRDS(paste0("output/at-sea model/maxent/", species, "_", stage, "_cbi_scores.rds")) %>%
  pull(.estimate) %>%
  mean()
gam_cbi <- readRDS(paste0("output/at-sea model/generalised additive models/", species, "_", stage, "_cbi_scores.rds")) %>%
  pull(.estimate) %>%
  mean()
bart_cbi <- readRDS(paste0("output/at-sea model/bayesian additive regression trees/", species, "_", stage, "_cbi_scores.rds")) %>%
  pull(.estimate) %>%
  mean()
...
writeRaster(simple, 
            filename = paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_simple_ensemble.tif"),
            overwrite = TRUE)
writeRaster(weighted,
            filename = paste0("output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_weighted_ensemble.tif"),
            overwrite = TRUE)
