...
writeRaster(southern_pred, 
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_rf_southern_prediction.tif"),
            overwrite = TRUE)
writeRaster(midrange_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_rf_midrange_prediction.tif"),
            overwrite = TRUE)
writeRaster(kerguelen_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_rf_kerguelen_prediction.tif"),
            overwrite = TRUE)
writeRaster(crozet_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_rf_crozet_prediction.tif"),
            overwrite = TRUE)
writeRaster(northern_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_rf_northern_prediction.tif"),
            overwrite = TRUE)
...
# export predictions
writeRaster(southern_pred, 
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_brt_southern_prediction.tif"),
            overwrite = TRUE)
writeRaster(midrange_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_brt_midrange_prediction.tif"),
            overwrite = TRUE)
writeRaster(kerguelen_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_brt_kerguelen_prediction.tif"),
            overwrite = TRUE)
writeRaster(crozet_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_brt_crozet_prediction.tif"),
            overwrite = TRUE)
writeRaster(northern_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_brt_northern_prediction.tif"),
            overwrite = TRUE)
...
# export predictions
writeRaster(southern_pred, 
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_maxent_southern_prediction.tif"),
            overwrite = TRUE)
writeRaster(midrange_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_maxent_midrange_prediction.tif"),
            overwrite = TRUE)
writeRaster(kerguelen_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_maxent_kerguelen_prediction.tif"),
            overwrite = TRUE)
writeRaster(crozet_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_maxent_crozet_prediction.tif"),
            overwrite = TRUE)
writeRaster(northern_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_maxent_northern_prediction.tif"),
            overwrite = TRUE)
...
# export predictions
writeRaster(southern_pred, 
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_gam_southern_prediction.tif"),
            overwrite = TRUE)
writeRaster(midrange_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_gam_midrange_prediction.tif"),
            overwrite = TRUE)
writeRaster(kerguelen_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_gam_kerguelen_prediction.tif"),
            overwrite = TRUE)
writeRaster(crozet_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_gam_crozet_prediction.tif"),
            overwrite = TRUE)
writeRaster(northern_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_gam_northern_prediction.tif"),
            overwrite = TRUE)
...
# export predictions
writeRaster(southern_pred, 
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_bart_southern_prediction.tif"),
            overwrite = TRUE)
writeRaster(midrange_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_bart_midrange_prediction.tif"),
            overwrite = TRUE)
writeRaster(kerguelen_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_bart_kerguelen_prediction.tif"),
            overwrite = TRUE)
writeRaster(crozet_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_bart_crozet_prediction.tif"),
            overwrite = TRUE)
writeRaster(northern_pred,
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_bart_northern_prediction.tif"),
            overwrite = TRUE)
...
rf <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_rf_northern_prediction.tif"))
brt <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_brt_northern_prediction.tif"))
gam <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_gam_northern_prediction.tif"))
bart <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_bart_northern_prediction.tif"))
...
# export simple prediction
writeRaster(simple, 
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_northern_simple_ensemble.tif"),
            overwrite = TRUE)
...
rf <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_rf_midrange_prediction.tif"))
brt <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_brt_midrange_prediction.tif"))
gam <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_gam_midrange_prediction.tif"))
bart <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_bart_midrange_prediction.tif"))
...
# export simple prediction
writeRaster(simple, 
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_midrange_simple_ensemble.tif"),
            overwrite = TRUE)
...
rf <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_rf_southern_prediction.tif"))
brt <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_brt_southern_prediction.tif"))
gam <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_gam_southern_prediction.tif"))
bart <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_bart_southern_prediction.tif"))
...
# export simple prediction
writeRaster(simple, 
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_southern_simple_ensemble.tif"),
            overwrite = TRUE)
...
rf <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_rf_kerguelen_prediction.tif"))
brt <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_brt_kerguelen_prediction.tif"))
gam <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_gam_kerguelen_prediction.tif"))
bart <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_bart_kerguelen_prediction.tif"))
...
# export simple prediction
writeRaster(simple, 
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_kerguelen_simple_ensemble.tif"),
            overwrite = TRUE)
...
rf <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_rf_crozet_prediction.tif"))
brt <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_brt_crozet_prediction.tif"))
gam <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_gam_crozet_prediction.tif"))
bart <- rast(paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_bart_crozet_prediction.tif"))
...
# export simple prediction
writeRaster(simple, 
            filename = paste0("penguins/output/at-sea model/predictions/", species, "_", stage, "_crozet_simple_ensemble.tif"),
            overwrite = TRUE)