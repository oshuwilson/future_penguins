...
# loop over every gcm and both scenarios
...
writeRaster(rf_pred, 
            filename = paste0("penguins/output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_rf_prediction.tif"),
            overwrite = TRUE)
...
writeRaster(brt_pred, 
            filename = paste0("penguins/output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_brt_prediction.tif"),
            overwrite = TRUE)
...
writeRaster(gam_pred, 
            filename = paste0("penguins/output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_gam_prediction.tif"),
            overwrite = TRUE)
...
writeRaster(bart_pred, 
            filename = paste0("penguins/output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_bart_prediction.tif"),
            overwrite = TRUE)
...
rf <- rast(paste0("penguins/output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_rf_prediction.tif"))
brt <- rast(paste0("penguins/output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_brt_prediction.tif"))
maxent <- rast(paste0("penguins/output/at-sea model/projections/", scenario, "/", gcm, "/", species, "_", stage, "_", gcm, "_", scenario, "_maxent_prediction.tif"))
