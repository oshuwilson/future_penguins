#---------------------------------------------------
# Fit Topographic Bayesian Additive Regression Trees
#---------------------------------------------------
...
# convert subarea to numeric for BART predictions
...
#trees <- seq(10, 100, 45) # for quick test runs
...
data2 <- readRDS(paste0("output/topographic model/model_data/", species, "_ml_data.rds"))
...
# export
saveRDS(metrics, 
        paste0("output/topographic model/bayesian additive regression trees/", species, "_cbi_scores.rds"))
...
# export
saveRDS(vi_scores, 
        paste0("output/topographic model/bayesian additive regression trees/", species, "_varimp_scores.rds"))
...
# export PDP values
saveRDS(pdps, 
        paste0("output/topographic model/bayesian additive regression trees/", species, "_pdp_values.rds"))
