#----------------------------------------------
# Fit Topographic Boosted Regression Trees
#----------------------------------------------
...
best_mod <- boost_tree() %>%
  ...
  set_mode("classification") %>%
  set_args(min_n = 10, trees = best$trees[1], 
...
# export
saveRDS(metrics, 
        paste0("output/topographic model/boosted regression trees/", species, "_cbi_scores.rds"))
...
# export
saveRDS(vi_scores, 
        paste0("output/topographic model/boosted regression trees/", species, "_varimp_scores.rds"))
...
# export PDP values
saveRDS(pdp_ovr, 
        paste0("output/topographic model/boosted regression trees/", species, "_pdp_values.rds"))
