#-------------------------------------------------------------------------------
# Evaluate projected species distribution changes in Domain 6
#-------------------------------------------------------------------------------
...
ggsave("text/figures/draft/domainplots/domain6/corehabitat.png", all_grid,
       width = 12, height = 12)
...
ggsave("text/figures/draft/domainplots/domain6/proposal.png",
       width = 10, height = 7) 
...
domainplot <- ggplot() +
  ...
  geom_spatvector(data = domains %>% filter(Name == "6"), fill = "darkred", col = NA) +
  scale_fill_grey(guide = "none") +
  theme_void()
domainplot + ggview::canvas(width = 6, height = 6)
ggsave("text/figures/draft/domainplots/domain6/domain_highlight.png")
