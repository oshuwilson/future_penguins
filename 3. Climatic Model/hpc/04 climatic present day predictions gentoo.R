...
regions <- c("northernmost", "midrange", "southern", "kerguelen", "crozet")
for(region in regions){
  ...
  # read in rasters
  # temp
  avg_temp <- rast(paste0("output/climatic model/rasters/temp/", species, "_", region, "_avg_temp.tif"))
  avg_min_temp <- rast(paste0("output/climatic model/rasters/temp/", species, "_", region, "_avg_min_temp.tif"))
  avg_max_temp <- rast(paste0("output/climatic model/rasters/temp/", species, "_", region, "_avg_max_temp.tif"))
  
  # precipitation
  avg_prec <- rast(paste0("output/climatic model/rasters/prec/", species, "_", region, "_avg_prec.tif"))
  avg_min_prec <- rast(paste0("output/climatic model/rasters/prec/", species, "_", region, "_avg_min_prec.tif"))
  avg_max_prec <- rast(paste0("output/climatic model/rasters/prec/", species, "_", region, "_avg_max_prec.tif"))
  
  # open water
  avg_now <- rast(paste0("output/climatic model/rasters/now/", species, "_", region, "_avg_now.tif"))
  avg_min_now <- rast(paste0("output/climatic model/rasters/now/", species, "_", region, "_avg_min_now.tif"))
  avg_max_now <- rast(paste0("output/climatic model/rasters/now/", species, "_", region, "_avg_max_now.tif"))
  ...
  writeRaster(pred_raster, 
              filename = paste0("output/climatic model/predictions/", species, "_", region, "_rf_prediction.tif"),
              overwrite = TRUE)
  ...
  writeRaster(pred_raster, 
              filename = paste0("output/climatic model/predictions/", species, "_", region, "_brt_prediction.tif"),
              overwrite = TRUE)
  ...
  writeRaster(pred_raster, 
              filename = paste0("output/climatic model/predictions/", species, "_", region, "_maxent_prediction.tif"),
              overwrite = TRUE)
  ...
  writeRaster(pred_raster, 
              filename = paste0("output/climatic model/predictions/", species, "_", region, "_gam_prediction.tif"),
              overwrite = TRUE)
  ...
  writeRaster(pred_raster, 
              filename = paste0("output/climatic model/predictions/", species, "_", region, "_bart_prediction.tif"),
              overwrite = TRUE)
  ...
  rf <- rast(paste0("output/climatic model/predictions/", species, "_", region, "_rf_prediction.tif"))
  brt <- rast(paste0("output/climatic model/predictions/", species, "_", region, "_brt_prediction.tif"))
  maxent <- rast(paste0("output/climatic model/predictions/", species, "_", region, "_maxent_prediction.tif"))
  gam <- rast(paste0("output/climatic model/predictions/", species, "_", region, "_gam_prediction.tif"))
  bart <- rast(paste0("output/climatic model/predictions/", species, "_", region, "_bart_prediction.tif"))
  ...
  writeRaster(simple, 
              filename = paste0("output/climatic model/predictions/", species, "_", region, "_simple_ensemble.tif"),
              overwrite = TRUE)
