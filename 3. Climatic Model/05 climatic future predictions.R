...
temp <- rast(paste0("E:/cmip6_data/CMIP6/deltas/tas/satellite_data/transformed/", gcm, "_", scenario, "_glorysres.tif"))
prec <- rast(paste0("E:/cmip6_data/CMIP6/deltas/pr/satellite_data/transformed/", gcm, "_", scenario, "_glorysres.tif"))
now <- rast(paste0("E:/cmip6_data/CMIP6/deltas/now/satellite_data/transformed/", gcm, "_", scenario, "_glorysres.nc"))
...
writeRaster(pred_raster, 
            filename = paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_rf_prediction.tif"),
            overwrite = TRUE)
...
writeRaster(pred_raster, 
            filename = paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_brt_prediction.tif"),
            overwrite = TRUE)
...
# export the prediction
writeRaster(pred_raster, 
            filename = paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_maxent_prediction.tif"),
            overwrite = TRUE)
...
# export the prediction
writeRaster(pred_raster, 
            filename = paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_gam_prediction.tif"),
            overwrite = TRUE)
...
# export the prediction
writeRaster(pred_raster, 
            filename = paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_bart_prediction.tif"),
            overwrite = TRUE)
...
rf <- rast(paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_rf_prediction.tif"))
brt <- rast(paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_brt_prediction.tif")) 
maxent <- rast(paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_maxent_prediction.tif"))
gam <- rast(paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_gam_prediction.tif"))
bart <- rast(paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_bart_prediction.tif"))
...
writeRaster(simple, 
            filename = paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_simple_ensemble.tif"),
            overwrite = TRUE)
writeRaster(weighted, 
            filename = paste0("output/climatic model/projections/", scenario, "/", gcm, "/", species, "_", gcm, "_", scenario, "_weighted_ensemble.tif"),
            overwrite = TRUE)
